...
const addGuiSettings = () => {
    ...
    if (typeof dat === 'undefined') {
        console.warn('dat.GUI not loaded, skipping GUI settings');
        return;
    }
...
// Wait for DOM and dat.GUI to be ready
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
        setTimeout(addGuiSettings, 100);
    });
} else {
    setTimeout(addGuiSettings, 100);
}
...
const handleResize = () => {
    ...
    canvas.width = newWidth * canvasSettings.ratio;
    canvas.height = newHeight * canvasSettings.ratio;
